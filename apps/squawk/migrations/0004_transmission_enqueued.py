...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TransmissionLog.enqueued'
        db.add_column('squawk_transmissionlog', 'enqueued', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TransmissionLog.enqueued'
        db.delete_column('squawk_transmissionlog', 'enqueued')


    models = {
        'squawk.apiuser': {
            'Meta': {'object_name': 'APIUser'},
            'api_key': ('django.db.models.fields.CharField', [], {'default': "'afe37129959050793273'", 'max_length': '20', 'db_index': 'True'}),
